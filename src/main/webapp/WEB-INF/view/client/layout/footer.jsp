                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://hoidanit.vn" target="_blank">
                                ...
                                <p class="text-secondary mb-0">@khonghung</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author: Khổng Hưng</p>
                            <p>Facebook: <a href="https://www.facebook.com/khuwn.205" target="_blank"> Khổng Hưng</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://www.facebook.com/khuwn.205" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Khổng Hưng</a>, All right
                            reserved.</span>
                    </div>
