...
<head>
    ...
    <title>Update Product ID ${id}</title>
    <link href="/css/styles.css" rel="stylesheet"/>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script>
        $(document).ready(() => {
            const imageInput = document.getElementById("imageFile");
            const oldImageName = "${updateProduct.image}";
            if (oldImageName && oldImageName.trim() !== "") {
                try {
                    const dataTransfer = new DataTransfer();
                    const file = new File([""], oldImageName);
                ...
                <div class="mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            <h1>Update Product with ID = ${id}</h1>
                            <hr/>
                            <form:form method="post" action="/admin/product/${id}/edit" modelAttribute="updateProduct"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="file" id="imageFile"
                                               accept=".png,.jpg,.jpeg"
                                               name="hungkhongFile"/>
                                        <span class="input-group-text bg-white" id="btnClearImage"
                                              style="cursor: pointer; border-left: none; color: #6c757d;">
                                ...
                                <div class="col-12 mb-3 d-flex justify-content-center">
                                    <img style="max-height: 250px; ${empty updateProduct.image ? 'display: none;' : ''}"
                                         alt="image preview"
                                         id="imagePreview"
